	...
	for (int i = 0; i < argc; i++) {
		if (strcmp(argv[i], "--timer") == 0 || strcmp(argv[i], "-t") == 0) {
			...
			printf(
				...
				"\n"
				"Available types:\n"
				"\thero              Represented as the \x1b[33mC\x1b[0m in game.\n"
				"\tenemy             Reptesented as the \x1b[31mE\x1b[0m in game.\n"
				"\teatable           Represented as the \x1b[31m@\x1b[0m in game.\n"
				"\tpowerup           Represented as the \x1b[37m*\x1b[0m in game.\n"
				"\n"
				"Available ids:\n"
